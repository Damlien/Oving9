...
Module:     letter_count_up_down
Purpose:    count from A-F either up or down on seven segment display. 
            
Depends:    /lib/debouncer.v,
            /lib/pos_edge_detector.v,
            /lib/D_vippe.v,
            /lib/seven_segment_display_0_F.v
=============================================================
*/
...
assign X =  clean_SW2;
// logic for counting through A-F, 
// 
assign D3 = 1'b1;
assign D2_next = ~D0 & D1 & D2 | ~D0 & D1 & X | D0 & D2 & X | ~D1 & D2 & ~X | D0 & D1 & ~D2 & ~X ;
assign D1_next = ~D0 & D1 & ~X | D0 & D1 & D2 | D1 & ~D2 & X | D0 & D2 & ~X | ~D0 & ~D1 & D2 & X ;
assign D0_next =~D0 & D1 | ~D0 & D2;
